...
# CodeMakers-Design — Code Makers · adaptação para Antigravity

Esta variante segue o formato Agent Skills: mantenha a pasta em `.agents/skills/codemakers-design`. Carregue referências e scripts apenas quando ajudarem a tarefa atual. O pacote não depende de metadados do Codex.
